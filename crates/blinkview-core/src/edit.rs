...
//!
//! This is the only part of blinkview that changes a photograph rather than moving it,
...
//! database and render on demand; we deliberately have no database, and `.blinkview/` is
